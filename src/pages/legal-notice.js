        ...
        <Layout>
            ...
            <section id="legalNotice" className="py-10 lg:py-20">
                <div className="container mx-auto px-8 tracking-wider">
                    ...
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line">
                        <span className="font-semibold"><Trans>LegalNoticeAlex</Trans></span>
                        <br/>
                        <Trans>LegalNoticeAlexTitle</Trans>
                    </p>
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line"><Trans>LegalNoticeAddress</Trans></p>
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line">
                    ...
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line"><Trans>LegalNoticePlace</Trans></p>
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line"><Trans>LegalNoticePurpose</Trans></p>
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line"><Trans>LegalNoticeVAT</Trans></p>
                    <p className="text-md lg:text-lg my-3 whitespace-pre-line">
