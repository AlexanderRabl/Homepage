      ...
      <section id="features" className="py-20 lg:pb-40 lg:pt-48">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              <span className="inline-block text-primary-700">
              ...
              <h1 className="text-2xl font-semibold text-gray-700 capitalize">Steuerberatung</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              ...
              <h1 className="text-2xl font-semibold text-gray-700 capitalize">Unternehmensgründung</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              ...
              <h1 className="text-2xl font-semibold text-gray-700 capitalize">Jahresabschluss & Steuererklärungen</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              ...
              <h1 className="text-2xl font-semibold text-gray-700 capitalize">Buchhaltung</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              ...
              <h1 className="text-2xl font-semibold text-gray-700 capitalize">Personalverrechnung</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              ...
              <h1 className="text-2xl font-semibold text-gray-700 capitalize">Internationale Steuern</h1>
