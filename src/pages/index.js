      ...
      <section id="features" className="py-20 lg:pb-40 lg:pt-48">
        <div className="container mx-auto text-center">
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div class="p-8 space-y-3 border-2 border-primary-700 rounded-xl">
              <span class="inline-block text-primary-700">
              ...
              <a href="#" class="inline-flex p-2 text-white capitalize transition-colors duration-200 transform bg-primary-100 rounded-full hover:underline hover:text-primary-900">
