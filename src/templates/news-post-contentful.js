...
const ContentfulPost = props => {
  const options = {
    ...
    renderNode: {
      ...
      [BLOCKS.HEADING_1]: (node, children) => {
        return <h1 className="text-6xl font-normal leading-normal mt-0 mb-2 font-light">{children}</h1>
      },
      [BLOCKS.HEADING_2]: (node, children) => {
        return <h2 className="text-5xl font-normal leading-normal mt-0 mb-2 font-light">{children}</h2>
      },
  ...
  return (
    <Layout>
      <section className="pt-20 md:pt-40">
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-2/3">
            ...
            <p className="mt-4 text-gray-600">{props.data.contentfulNewsPost.author}, {props.data.contentfulNewsPost.publishedDate}</p>
          </div>
      ...
      <section className="pt-20 md:pt-40 mb-10">
