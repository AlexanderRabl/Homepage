...
const PageHeader = ({ children }) => (
    ...
    <div className="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
      <div className="text-center">
        ...
        <button className="w-full px-4 py-2 mt-4 text-sm font-medium text-white uppercase transition-colors duration-200 transform bg-primary-700 rounded-md lg:w-auto hover:bg-primary-400 focus:outline-none focus:bg-primary-400">Kontakt</button>
      </div>
    </div>
  </div>
);
